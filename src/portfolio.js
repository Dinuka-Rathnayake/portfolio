...
const seo = {
  ...
  og: {
    ...
    type: "website",
    url: "https://dinuka-rathnayake.github.io/portfolio/#/",
  },
};
  ...
  data: [
    ...
    // },
    {
      ...
      skills: [
        ...
        "⚡ Creating application backend in Node, Express, php & Java",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
...
const contactPageData = {
  ...
  addressSection: {
    title: "Address",
    subtitle: "No.186/5A, Kudaligas Place, Weliwita Rd, Malabe",
    locality: "Colombo",
    country: "SL",
    region: "Colombo",
    postalCode: "385520",
    ...
    location_map_link: "https://maps.app.goo.gl/LU74n9eSZFTvQr8u5?g_st=iw",
  },
  phoneSection: {
    title: "",
    subtitle: "",
